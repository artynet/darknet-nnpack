...
void test_yolo(char *cfgfile, char *weightfile, char *filename, float thresh, char *output_file)
{
    ...
    while(1){
        ...
        draw_detections_output(im, l.side*l.side*l.n, thresh, boxes, probs, voc_names, alphabet, 20, output_file);
...
void run_yolo(int argc, char **argv)
{
    ...
    if(0==strcmp(argv[2], "test")) test_yolo(cfg, weights, filename, thresh, output_file);
